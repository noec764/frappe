	...
	>
		...
		>
			<div v-if="!is_dragging">
				...
				<div class="mt-2 text-center file-upload-buttons">
					<button class="btn btn-file-upload" @click="browse_files">
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="15" cy="15" r="15" fill="var(--subtle-fg)"/>
							<path d="M13.5 22V19" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
							<path d="M16.5 22V19" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
							<path d="M10.5 22H19.5" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
							<path d="M7.5 16H22.5" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
							<path d="M21 8H9C8.17157 8 7.5 8.67157 7.5 9.5V17.5C7.5 18.3284 8.17157 19 9 19H21C21.8284 19 22.5 18.3284 22.5 17.5V9.5C22.5 8.67157 21.8284 8 21 8Z" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						<div>{{ __('My Device') }}</div>
					</button>
					<input
						type="file"
						class="hidden"
					...
					<button class="btn btn-file-upload" v-if="!disable_file_browser" @click="show_file_browser = true">
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path d="M8.87939 9.5V8.5C8.87939 8.22386 9.10325 8 9.37939 8H20.6208C20.8969 8 21.1208 8.22386 21.1208 8.5V12" stroke="var(--primary)" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						<div>{{ __('Library') }}</div>
					</button>
					<button class="btn btn-file-upload" v-if="allow_web_link" @click="show_web_link = true">
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="15" cy="15" r="15" fill="var(--subtle-fg)"/>
							<path d="M12.0469 17.9543L17.9558 12.0454" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
							...
							<path d="M11.4547 13.8184L9.47873 15.7943C8.85205 16.4212 8.5 17.2714 8.5 18.1578C8.5 19.0443 8.85205 19.8945 9.47873 20.5214V20.5214C10.1057 21.1481 10.9558 21.5001 11.8423 21.5001C12.7287 21.5001 13.5789 21.1481 14.2058 20.5214L16.1818 18.5455" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						<div>{{ __('Link') }}</div>
					</button>
					<button v-if="allow_take_photo" class="btn btn-file-upload" @click="capture_image">
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<circle cx="15" cy="16" r="2.5" stroke="var(--primary)"/>
						</svg>
						<div>{{ __('Camera') }}</div>
					</button>
