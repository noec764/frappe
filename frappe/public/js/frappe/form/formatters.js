...
frappe.form.formatters = {
	...
	Currency: function (value, docfield, options, doc) {
		...
		var precision = docfield.precision || cint(frappe.boot.sysdefaults.currency_precision) || cint(frappe.boot.sysdefaults.float_precision) || 2;
	...
	Datetime: function(value) {
		if(value) {
			return moment(frappe.datetime.convert_to_user_tz(value))
				.format(frappe.boot.sysdefaults.date_format.toUpperCase() + ' ' + frappe.boot.sysdefaults.time_format || 'HH:mm');
		} else {
			return "";
		}
	},
