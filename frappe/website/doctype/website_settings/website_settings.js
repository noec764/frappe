frappe.ui.form.on("Website Settings", {
	...
	edit_template_values(frm, template_field) {
		...
		erpnext.website.open_web_template_values_editor(template, values).then((new_values) => {
...
frappe.tour["Website Settings"] = [
	...
	},
	{
		...
		description: __(
			"Link a webform containing a custom signup form that will replace the standard signup form."
		),
	},
];
