...
def new_site(site, mariadb_root_username=None, mariadb_root_password=None, admin_password=None,
	verbose=False, source_sql=None, force=None, no_mariadb_socket=False,
	...
	_new_site(db_name, site, mariadb_root_username=mariadb_root_username,
			...
			no_mariadb_socket=no_mariadb_socket, db_password=db_password, db_type=db_type, db_host=db_host, db_port=db_port, new_site=True)
...
def _new_site(db_name, site, mariadb_root_username=None, mariadb_root_password=None,
	...
	no_mariadb_socket=False, reinstall=False, db_password=None, db_type=None, db_host=None, db_port=None, new_site=False):
