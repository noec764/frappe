...
class Workspace(Document):
	...
	def on_update(self):
		...
		if frappe.conf.developer_mode and self.public and self.is_standard:
			if self.module:
...
@frappe.whitelist()
def update_page(name, title, icon, color, parent, public):
	public = frappe.parse_json(public)
