...
frappe.tour["Event"] = [
	{
		...
		description: __("This is the topic/purpose of your event. This information allows you to know what your event is about."),
	},
	{
		fieldname: "starts_on",
		title: __("Starts on"),
	...
	},
	{
		...
		description: __("Define the type of event: a meeting, an event (e.g. trade show), a call, an email sent."),
	},
	{
		fieldname: "ends_on",
		title: __("Ends on"),
	...
	},
	{
		...
		title: __("Event type"),
		description: __("Define if your event is private or public. If your event is cancelled you can indicate it here."),
	},
	{
		fieldname: "status",
		title: __("Status"),
		description: __("Indicate the status of the event. The event can be 'Confirmed', 'Unconfirmed', 'Open', 'Cancelled', 'Closed'."),
	},
	{
		fieldname: "all_day",
		title: __("All day"),
	...
	},
	{
		...
		description: __("If the box is checked, a pop-up will open asking you to choose the recurrence of the event. Specify the frequency, until when the event should be repeated and the frequency interval."),
	},
	{
	...
	},
	{
		...
		description: __("In this section, fill in all the descriptive information about the event."),
	}
]
