...
def get_bootinfo():
	...
	bootinfo.fullcalendar_scheduler_licence_key = [l for l in frappe.get_hooks("fullcalendar_scheduler_licence_key") if l != ""][-1]
...
def load_print_css(bootinfo, print_settings):
	...
	bootinfo.print_css = frappe.www.printview.get_print_style(
		print_settings.print_style or "TwentyTwenty", for_legacy=True
	)
