...
frappe.ui.form.on('DocType', {
	...
	set_naming_rule_description(frm) {
		let naming_rule_description = {
			'Set by user': '',
			'Autoincrement': __('Uses Auto Increment feature of database.<br><b>WARNING: After using this option, any other naming option will not be accessible.</b>'),
			'By fieldname': __('Format: <code>field:[fieldname]</code>. Valid fieldname must exist'),
			'By "Naming Series" field': __('Format: <code>naming_series:[fieldname]</code>. Fieldname called <code>naming_series</code> must exist'),
			'Expression': __('Format: <code>format:EXAMPLE-{MM}morewords{fieldname1}-{fieldname2}-{#####}</code> - Replace all braced words (fieldnames, date words (DD, MM, YY), series) with their value. Outside braces, any characters can be used.'),
			'Expression (old style)': __('Format: <code>EXAMPLE-.#####</code> Series by prefix (separated by a dot)'),
			'Random': '',
			'By script': ''
		};
