...
This file implements a "weak" form lock which is not suitable for synchronization. This is only used
for document locking for queue_action.
Use `frappe.utils.synchronization.filelock` for process synchroniztion.
"""
