...
def encrypt(txt, encryption_key=None):
	...
	try:
		...
		frappe.throw(_("Encryption key format is invalid!"))
...
def decrypt(txt, encryption_key=None):
	...
	try:
		...
		frappe.throw(
			...
			+ "<br>"
			+ _(
				"If you have recently restored the site you may need to copy the site config containing the original Encryption Key."
			)
		)
